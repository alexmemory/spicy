...
public class Test05VerticalPartition extends TestFixture {

    private Log logger = LogFactory.getLog(this.getClass());

    public void testCopying() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(Riferimenti.stMark05VerticalPartition).toURI()).getAbsolutePath();
