...
public class Riferimenti {
    ...
    private static Log logger = LogFactory.getLog(Riferimenti.class);
    ...
    public static final String houston = "/resources/houston/houston-mappingTask.xml";
    // STMark
    public static final String stMark01Copying = "/resources/STMark/01Copying/01Copying-mappingTask.xml";
    public static final String stMark05VerticalPartition = "/resources/STMark/05VerticalPartition/05VerticalPartition-mappingTask.xml";
